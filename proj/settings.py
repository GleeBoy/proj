...
SECRET_KEY = 'pw7-gwul%f5a^%2)pjl4m+w4kr^%+%%pidu94wp57y)01b3j5*'
...
STATIC_URL = '/static/'
# STATIC_ROOT = os.path.join(BASE_DIR, 'static/')     # collectstatic 的目录
STATICFILES_DIRS = [
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://127.0.0.1:6379/1",     # 目前celery0，缓存1，
        "OPTIONS": {
